...
func main() {
	car1, err := newCar("nissan 350z", 3.2, 4, 3, "black", true, 20000.00)
	...
	car1.changeEngine(231)
	fmt.Println(car1)
}

func newCar(model string, engine float64, wheels int, doors int, color string, isNew bool, price float64) (Car, error) {
	if model == "" {
